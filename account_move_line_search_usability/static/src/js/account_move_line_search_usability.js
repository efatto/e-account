...
*/
openerp.account_move_line_search_usability = function (instance) {
    var QWeb = instance.web.qweb;

    instance.account_move_line_search_usability = {};

    instance.web.views.add('account_move_line_search_usability', 'instance.account_move_line_search_usability.ListSearchView');
    instance.account_move_line_search_usability.ListSearchView = instance.web.ListView.extend({
        ...
        start: function(){
            ...
            var self = this;
            this.$el.parent().prepend(QWeb.render('AccountMoveLineSearchUsability', self.groups_dict));
