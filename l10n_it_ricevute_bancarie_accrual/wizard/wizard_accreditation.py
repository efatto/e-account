...
class RibaAccreditation(models.TransientModel):
    ...
    def create_move(self):
        ...
        date_accreditation = wizard.date_accreditation or fields.Date.context_today(
            self
        )
    ...
    date_accreditation = fields.Date(
        string="Accreditation date", default=_get_accreditation_date
    )
    accreditation_amount = fields.Float(
        string="Credit amount", default=_get_accreditation_amount
    )
    bank_amount = fields.Float(
        string="Versed amount", default=_get_accreditation_amount
    )
